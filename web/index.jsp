...
<html>
    ...
    if (user != null && user.isLogado()) {
        ...
        <div class="texto1">
            <p id="titulo1">Nunca foi tão fácil chegar ao trabalho!</p>
        ...
        <footer>
           <!-- <iframe width="100%" height="269px" src="https://mdbootstrap.com/api/snippets/embed/1279184/fullscreen" frameborder="0"></iframe>-->
            <iframe width="100%" height="342px" src="https://mdbootstrap.com/api/snippets/embed/1482441/fullscreen" frameborder="0"></iframe>
        </footer>      
        <script>
            $("#fotos > div:gt(0)").hide();
